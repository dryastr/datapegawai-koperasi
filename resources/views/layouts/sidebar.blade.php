    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            @if (auth()->user()->role->name == 'admin')
                ...
                <li class="sidebar-item has-sub {{ Request::is('admin.jabatans*') ? 'active' : '' }}">
                    <a href="#" class='sidebar-link'>
                    ...
                    <ul class="submenu">
                        <li class="submenu-item {{ Request::routeIs('admin.jabatans.index') ? 'active' : '' }}">
                            <a href="{{ route('admin.jabatans.index') }}" class="submenu-link">Daftar Jabatan</a>
                        </li>
                        <li class="submenu-item {{ Request::routeIs('admin.jabatans.create') ? 'active' : '' }}">
                            <a href="{{ route('admin.jabatans.create') }}" class="submenu-link">Tambah Jabatan</a>
                        </li>
                    </ul>
                </li>
            @endif
